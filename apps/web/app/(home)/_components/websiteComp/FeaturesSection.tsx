      ...
      <div className="relative mx-auto max-w-[1563px] md:p-14 p-6 md:border-l md:border-r border-[#333333]">
        ...
        <div className="relative z-10 py-2 pb-48">
            ...
            <div className="space-y-6 text-white/80 text-lg leading-relaxed flex pt-72">
              ...
              <p className="mb-5">
                At <span className="text-primary">AI Code Review Platform</span>, we believe intelligence isn't just about generating answers—it's about understanding context, reasoning through complexity, and acting with intent.
              </p>
              <p>
        ...
        <div className="relative z-10">
          <div className="mb-12 flex flex-col items-start justify-between gap-6 md:flex-row md:items-center">
            ...
            <Link href="/interact">
              ...
              >
                See How to Interact with AI Code Review
...
Start chatting and watch the workflow build itself. Code, tests, issues, reviews — done faster, and smarter with every use.                  </p>
            ...
            <FeatureCard className="p-2 lg:col-span-1">         
              ...
              <CardHeading
                icon={MapIcon}
                title="Tag AI Code Review"
                description="Got a question? Just ask @AI Code Review."

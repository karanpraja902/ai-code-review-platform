    ...
    <div className="mx-auto max-w-3xl px-6 py-12">
      <div className="space-y-6">
        ...
        <p className="text-muted-foreground">
          Thanks for using AI Code Review Platform. We’re an engineering agent that thinks
          like humans and works better with them. If something isn’t behaving as
          expected on{" "}
          <span className="font-semibold">https://ai-code-review-platform.dev</span>, let us
          ...
          <div className="space-y-3">
            ...
            <ol className="list-decimal space-y-2 pl-6">
              <li>
                ...
                <br />
                <a
                  href="https://github.com/karanpraja902/ai-code-review-platform/report-a-bug/issues/new"
                  target="_blank"
                  rel="noreferrer"
                  className="text-primary underline"
                >
                  github.com/karanpraja902/ai-code-review-platform/report-a-bug/issues/new
                </a>
              </li>
              <li>
        ...
        <div className="space-y-4">
          ...
          <p className="text-muted-foreground">
            ...
            to discuss about AI Code Review. If you prefer a quick chat, feel free to
            schedule a call.
          </p>
          <ul className="list-disc space-y-2 pl-6">
            <li>
              Email:{" "}
              <a
                href="mailto:karanpraja902@gmail.com"
                className="text-primary underline"
              >
                karanpraja902@gmail.com
              </a>
            </li>
            <li>
              Schedule:{" "}
              <a
                href="https://cal.com/karanpraja902/ai-code-review"
                className="text-primary underline"
                target="_blank"
                rel="noreferrer"
              >
                cal.com/karanpraja902/ai-code-review
              </a>
            </li>
          </ul>
        </div>
        ...
        <blockquote className="rounded-md border p-4 text-sm leading-relaxed">
          ...
          Together, we make AI Code Review Platform better 🪲✨
        </blockquote>

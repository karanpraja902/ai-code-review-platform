...
const ParallaxAI Code Review = () => {
  ...
  const letters = "AI CODE REVIEW".split("");
    ...
    <>
      ...
      <section className="fixed bottom-0 h-[10rem] sm:h-[14rem] md:h-[20rem] lg:h-[22rem] xl:h-[24rem] xxl:h-[26rem] bg-primary w-full -z-10 -mx-2 sm:-mx-5">
        <div className="absolute inset-0 flex items-center justify-center">
          <h1 className="ai-code-review-text-1480 text-[5rem] font-black text-black/90 select-none leading-none tracking-tighter flex">

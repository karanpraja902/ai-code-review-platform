            ...
            <div className="prose prose-invert max-w-none space-y-16">
              <section id="hosting" className="scroll-mt-24">
                ...
                <p className="text-lg leading-relaxed text-zinc-400">
                  AI Code Review is currently available as a cloud-based service, and we
                  ...
                  <div className="space-y-6 text-zinc-400">
                    ...
                    <div className="space-y-4">
                      <h4 className="font-medium text-white">
                        How AI Code Review Handles Your Code End-to-End Securely
                      </h4>
                      <ul className="list-disc space-y-2 pl-5">
                        ...
                        <li>
                          ...
                          AI Code Review uses SOC 2 Type II certified platforms (like
                          MongoDB Atlas).
                        </li>
                      </ul>
                    </div>
                    ...
                    <div className="rounded-md border border-[#333333] bg-[#0a0a0a] p-4">
                      ...
                      <p>
                        AI Code Review never stores your code, never exposes it, and
...
<p className="leading-relaxed">
This infrastructure for AI Code Review is provided and hosted by
